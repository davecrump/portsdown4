...
screen_pixel_t2 main_waterfall_buffer[MAIN_WATERFALL_HEIGHT][MAIN_WATERFALL_WIDTH] __attribute__ ((aligned (NEON_ALIGNMENT)));
...
void new_waterfall_render_fft(uint8_t *fft_data);
