...
# This script is called from the GUI to enable the 2nd Pluto processor
...
timeout 2 sshpass -p analog ssh -o StrictHostKeyChecking=no root@"$PLUTOIP" 'PATH=/bin:/sbin:/usr/bin:/usr/sbin;fw_setenv maxcpus'
